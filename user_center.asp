...
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="672" height="22" bgcolor="E43A23">&nbsp;为方便各位代理方便查询到自己的衣服排位，特此加这个搜索，方便使用！</td>
  </tr>
</table>
...
if rs.eof and rs.bof  then
	response.write "<tr><td height=30 colspan=8 align=center class=red>欢迎登陆 暂时没有您想要的订单!</td></tr>"
	else
