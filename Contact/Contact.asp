...
<div id='div_Public'>
  ...
  <div id='Contact_top_left'>
    <div id="sidepanel">
      <h2>快速导航</h2>
      <ul>
        <li>◇ <a href="/Contact/Contact.asp?id=3">普通快递</a></li>
        <li>◇ <a href="/Contact/Contact.asp?id=5">免邮费优惠</a></li>
        <li>◇ <a href="/Contact/Contact.asp?id=6">联系我们</a></li>
        <li>◇ <a href="/Contact/Contact.asp?id=7">如何换货</a></li>
        <li>◇ <a href="/Contact/Contact.asp?id=8">代理须知</a></li>
        <li>◇ <a href="/Contact/Contact.asp?id=9">如何退款</a></li>
      </ul>
    </div>
    <div id="sidepanel">
      <h2>客户服务中心</h2>
