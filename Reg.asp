...
function Checkreg()
{
	...
	if (document.ADDUser.tjr.value.length < 1 ) {
		alert("提示：请输入推荐人");
		document.ADDUser.tjr.focus();
		return false;
	}
...
<div id='div_Public'>
  <div id='mid_login'>
	...
	<form name="ADDUser" method="POST" action="reg_save.asp" onSubmit="return Checkreg();">
      <tr>
        <td height="50" colspan="2" valign="bottom" style="border-bottom-width: 2px;border-bottom-style: solid;border-bottom-color: #010101;"><img src="image/login/mid/zhuce.jpg" width="102" height="25" />		</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td height="30" bgcolor="#FFFFFF"><input name="HomePhone"  class=uset_input id="HomePhone" size="30">
          <span class=red> *</span>格式如:028-86888888或者13988888888 </td>
      </tr>
      <tr>
      ...
      <TR>
        <TD height=30 align=right bgcolor="#FAFCF3"><span class="red"><span class="size_16">推荐人</span>：</span></TD>
        <TD height="30" colspan="2" align=left bgcolor="#FAFCF3" ><input name="tjr" type="text" class="uset_input" id="tjr" /></TD>
      </TR>
	  <tr>
